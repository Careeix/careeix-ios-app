...
//  Careeix
//
//  Created by mingmac on 2022/10/16.
//

import Foundation

class HomeViewModel {
    let minimalCareerProfile: [CareerModel] = [CareerModel(profileImage: "person", nickname: "키키", careerName: "UI 디자이너", careerGrade: "주니어(1~4년차)", detailCareerName: ["#ui디자이너", "#ux디자이너", "#uiux디자이너"])]
    
    let releventCareerProfiles: [RelevantCareerModel] = [
